...
class CostcoList extends Component {
	...
	constructor(props) {
  	super(props);
		...
		let costcoRef = 'Lists/Costco';
		this.itemsRef = firebase.database().ref(costcoRef);
	}
		...
		return (
			<View style={styles1.container}>
				<View style={styles.container}>
					<Text style={styles.header}>Costco</Text>
