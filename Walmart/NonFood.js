...
class NonFoodList extends Component {
	...
	constructor(props) {
  	super(props);
		...
		let nonFoodRef = 'Lists/Walmart/Non Food';
		this.itemsRef = firebase.database().ref(nonFoodRef);
	}
		...
		return (
			<View style={styles1.container}>
				<View style={styles.container}>
					<Text style={styles.header}>Non-Food</Text>
