...
class MiscFoodList extends Component {
	...
	constructor(props) {
  	super(props);
		...
		let miscFoodRef = 'Lists/Walmart/Misc Food';
		this.itemsRef = firebase.database().ref(miscFoodRef);
	}
		...
		return (
			<View style={styles1.container}>
				<View style={styles.container}>
					<Text style={styles.header}>Misc. Food</Text>
