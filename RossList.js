...
class RossList extends Component {
	...
	constructor(props) {
  	super(props);
		...
		let rossRef = 'Lists/Ross';
		this.itemsRef = firebase.database().ref(rossRef);
	}
		...
		return (
			<View style={styles1.container}>
				<View style={styles.container}>
					<Text style={styles.header}>Ross</Text>
